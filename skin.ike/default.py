...
base='YOUR SITE HERE'
ADDON=xbmcaddon.Addon(id='skin.ike')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/09inx5goec61kfd/skin.ike.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("skin.ike","Downloading ",'', 'Please Wait')
