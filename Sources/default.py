...
base='YOUR SITE HERE'
ADDON=xbmcaddon.Addon(id='Sources')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/ilbywa7rzz0kcng/wizard.Sources.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Sources","Downloading ",'', 'Please Wait')
