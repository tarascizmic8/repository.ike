...
base='YOUR SITE HERE'
ADDON=xbmcaddon.Addon(id='phenon.17')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/d7x1zmtzem1wwpf/phenon.17.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("phenon.17","Downloading ",'', 'Please Wait')
